...
DATABASE_ROUTERS = ['orders.routers.SessionRouter']
...
#RazorPay
RAZORPAY_ID = 'YOUR-KEY-HERE'
RAZORPAY_ACCOUNT_ID = 'YOUR-SECRET-KEY-HERE'
...
STATICFILES_STORAGE = 'orders.storage_backend.StaticStorage'
# STATICFILES_STORAGE = 'storages.backends.s3boto3.S3Boto3Storage'

# Public Media file (User uploaded Images)
MEDIA_URL = f'https://{AWS_S3_CUSTOM_DOMAIN}/media/'
DEFAULT_FILE_STORAGE = 'orders.storage_backend.PublicMediaStorage'
# DEFAULT_FILE_STORAGE = 'storages.backends.s3boto3.S3Boto3Storage'
# Private Media file 
PRIVATE_MEDIA_LOCATION = 'private'
PRIVATE_FILE_STORAGE = 'orders.storage_backend.PrivateMediaStorage'
